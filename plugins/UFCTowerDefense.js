...
@type text
@desc Set the color of towers' Attack Range. Default = #e03404
@default #17b978
...
@type text
@desc Set the color of aura towers' Aura Range. Default = #0497e0
@default #17b978
...
Game_TDEnemy.prototype.updateEffects = function () {
  for (const effect in this._effects) {
    ...
    if (!this._effects[effect].enable) {
      ...
      let passive = false;
      switch (effect) {
        case TowerDefenseManager.EFFECTS.CHILL:
          ...
          break;
		  case TowerDefenseManager.EFFECTS.FREEZE:
          this.addMoveSpeedEffect(
            effect,
            -this._realMoveSpeed *
              (this._effects[effect].effect.getEffect() / 100),
          ...
          break;
		  case TowerDefenseManager.EFFECTS.HINDER:
          this.addMoveSpeedEffect(
            effect,
            -this._realMoveSpeed *
              (this._effects[effect].effect.getEffect() / 100),
          ...
          break;
		  case TowerDefenseManager.EFFECTS.CRIPPLE:
          this.addMoveSpeedEffect(
            effect,
            -this._realMoveSpeed *
              (this._effects[effect].effect.getEffect() / 100),
          ...
          break;
		  case TowerDefenseManager.EFFECTS.WARP:
          this.addMoveSpeedEffect(
            effect,
            -this._realMoveSpeed *
              (this._effects[effect].effect.getEffect() / 100),
          ...
          break;
		  case TowerDefenseManager.EFFECTS.DEBILITATE:
          this.addMoveSpeedEffect(
            effect,
            -this._realMoveSpeed *
              (this._effects[effect].effect.getEffect() / 100),
          ...
          break;
		  case TowerDefenseManager.EFFECTS.BLEED:
        ...
        case TowerDefenseManager.EFFECTS.POISON:
          ...
          break;
		  case TowerDefenseManager.EFFECTS.BURN:
          this._effects[effect].effect.setEPSCallback(() =>
            this.attacked({ damage: this._effects[effect].effect.getEffect() })
          );
          break;
